...
public class ImportSelectorTest {
    ...
    @Test
    void selectorConfig(){
        AnnotationConfigApplicationContext selectorConfig = new AnnotationConfigApplicationContext(StaticConfig.class);
        HelloBean bean = selectorConfig.getBean(HelloBean.class);
        assertThat(bean).isNotNull();
    }
